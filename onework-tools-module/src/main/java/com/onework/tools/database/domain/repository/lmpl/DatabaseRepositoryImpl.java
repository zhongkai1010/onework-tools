...
public class DatabaseRepositoryImpl implements DatabaseRepository {
    ...
    @Override
    public void insertDatabase(DatabaseVo database) {
    ...
    @Override
    public DatabaseVo getDatabaseByName(String connId, String dbName) {
        ...
        return BeanUtil.copyProperties(databaseDb, DatabaseVo.class);
    }
}
