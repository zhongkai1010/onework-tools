...
public class ModelItemRepositoryImpl implements ModelItemRepository {
    ...
    public ModelItem query(String code) {
        com.onework.tools.model.entity.ModelItem item = new LambdaQueryChainWrapper<>(modelItemMapper).eq(
            com.onework.tools.model.entity.ModelItem::getCode, code).one();
        return BeanUtil.copyProperties(item, ModelItem.class);
    }

    @Override
    public void insert(ModelItem modelItem) {
        com.onework.tools.model.entity.ModelItem item = BeanUtil.copyProperties(modelItem,
            com.onework.tools.model.entity.ModelItem.class);
    ...
    public void update(ModelItem modelItem) {
        ...
        boolean result = new LambdaUpdateChainWrapper<>(modelItemMapper).eq(
                com.onework.tools.model.entity.ModelItem::getCode, modelItem.getCode())
            .set(com.onework.tools.model.entity.ModelItem::getName, modelItem.getName())
            .set(com.onework.tools.model.entity.ModelItem::getType, modelItem.getType())
            .set(com.onework.tools.model.entity.ModelItem::getCumulate, modelItem.getCumulate()).update();
    ...
    public void delete(String code) {
        ...
        LambdaQueryChainWrapper<com.onework.tools.model.entity.ModelItem> queryChainWrapper
            = new LambdaQueryChainWrapper<>(modelItemMapper).eq(com.onework.tools.model.entity.ModelItem::getCode,
            code);
