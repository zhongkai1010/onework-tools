...
public class ModelDataItemRepositoryImpl implements ModelDataItemRepository {
    ...
    public void deleteModeDataItems(String dataCode) {
        LambdaQueryWrapper<com.onework.tools.service.model.entity.ModelDataItem> lambdaQueryWrapper =
            new LambdaQueryWrapper<>();
        lambdaQueryWrapper.eq(com.onework.tools.service.model.entity.ModelDataItem::getDataCode, dataCode);
        modelDataItemMapper.delete(lambdaQueryWrapper);
    }

    @Override
    public void insert(ModelDataItem items) {
        com.onework.tools.service.model.entity.ModelDataItem item =
            BeanUtil.copyProperties(items, com.onework.tools.service.model.entity.ModelDataItem.class);
