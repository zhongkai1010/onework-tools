...
import com.onework.tools.domain.model.entity.ModelCollection;
import com.onework.tools.domain.model.repository.ModelCollectionRepository;
import com.onework.tools.service.model.mapper.ModelCollectionMapper;
...
public class ModelCollectionRepositoryImpl implements ModelCollectionRepository {
    ...
    public ModelCollection query(String code) {
        ...
        com.onework.tools.service.model.entity.ModelCollection collection =
            new LambdaQueryChainWrapper<>(modelCollectionMapper).eq(
                com.onework.tools.service.model.entity.ModelCollection::getCode, code).one();
    ...
    public ModelCollection insert(ModelCollection modelCollection) {
        ...
        com.onework.tools.service.model.entity.ModelCollection collection =
            new com.onework.tools.service.model.entity.ModelCollection();
    ...
    public ModelCollection update(ModelCollection modelCollection) {
        ...
        boolean result = new LambdaUpdateChainWrapper<>(modelCollectionMapper).eq(
                com.onework.tools.service.model.entity.ModelCollection::getCode, modelCollection.getCode())
            .set(com.onework.tools.service.model.entity.ModelCollection::getName, modelCollection.getName())
            .set(com.onework.tools.service.model.entity.ModelCollection::getItems, items)
            .set(com.onework.tools.service.model.entity.ModelCollection::getDescription, modelCollection.getDescription())
            .update();
    ...
    public void delete(String code) {
        ...
        LambdaQueryChainWrapper<com.onework.tools.service.model.entity.ModelCollection> queryChainWrapper =
            new LambdaQueryChainWrapper<>(modelCollectionMapper).eq(
                com.onework.tools.service.model.entity.ModelCollection::getCode, code);
