...
public class ModelDataBehaviorRepositoryImpl implements ModelDataBehaviorRepository {
    ...
    public void deleteModeDataBehaviors(String dataCode) {
        LambdaQueryWrapper<com.onework.tools.model.entity.ModelDataBehavior> lambdaQueryWrapper
            = new LambdaQueryWrapper<>();
        lambdaQueryWrapper.eq(com.onework.tools.model.entity.ModelDataBehavior::getDataCode, dataCode);
