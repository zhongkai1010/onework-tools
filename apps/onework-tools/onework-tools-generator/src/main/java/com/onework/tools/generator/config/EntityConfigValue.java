...
public class EntityConfigValue {
     ...
     * 名称转换实现
     */
    private String nameConvert = null;
     ...
     * 逻辑删除字段名(数据库)
     */
    private String logicDeleteColumnName = null;

    /**
     * 逻辑删除属性名(实体)
     */
    private String logicDeletePropertyName = null;
     ...
     * 添加父类公共字段
     */
    private String[] addSuperEntityColumns = null;

    /**
     * 添加忽略字段
     */
    private String[] addIgnoreColumns = null;

    /**
     * 添加表字段填充
     */
    private IFill[] addTableFills = null;
