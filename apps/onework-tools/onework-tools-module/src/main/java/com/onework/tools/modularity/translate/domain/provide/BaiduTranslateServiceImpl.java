package com.onework.tools.modularity.translate.domain.provide;
...
import com.onework.tools.modularity.translate.TranslateProperties;
import com.onework.tools.modularity.translate.domain.ThreeTranslateService;
...
public class BaiduTranslateServiceImpl implements ThreeTranslateService {
    ...
    public TranslateResult translateText(String text) {
        return translateText(Language.zh, Language.en, new ArrayList<String>() {
            private static final long serialVersionUID = 2731716506399511961L;
