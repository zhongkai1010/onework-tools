package com.onework.tools.domain.form;
...
public enum FormException implements ErrorMessage {
    /**
     *
     */
    ...
    FormException(String code, String message) {
        this.code = code;
