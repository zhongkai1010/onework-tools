 ...
 * @LastEditors: 钟凯
 * @LastEditTime: 2021-03-31 16:01:09
 * @description
 * @FilePath: \egg_ts\app\core\baseController.ts
 */
...
export default class BaseController extends Controller {
  ...
  protected result(data:any, success = true) {
    this.ctx.body = this.ctx.helper.getRequestWrapper(data, success, null);
  }
